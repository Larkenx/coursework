...
class Test implements Serializable {
    ...
    private HashTable<Character,Double> charFreqs;
    // private Map<Character,String> codes;
    private HashTable<Character,String> codes;
    ...
    Test(HashTable<Character,Double> charFreqs,HashTable<Character,String> codes){
	this.charFreqs = charFreqs;
	this.codes = codes;
    }

    // public Map<Character,Double> getCharFreq(){
    public HashTable<Character,Double> getCharFreq(){
	return this.charFreqs;
    }

    // public Map<Character,String> getCodes(){
    public HashTable<Character,String> getCodes(){
	return this.codes;
    }
...
public class Driver {
    ...
    public static HashTable<Character,String> runHuffCode(HashTable<Character,Double> charFreqs){
	...
	HashTable<Character,String> codes = new HashTableImp<Character,String>(50,HashMethod.MAD);
    ...
    public static void normalize(HashTable<Character,Double> charFreqs){
	int total = 0;
	for (char c : charFreqs.keySet()){
    ...
    public static double calcTotalBits(HashTable<Character,Double> freq,HashTable<Character,String> code){
	double sum = 0;
    ...
    public static HashTable<Character,Double> getRandomFreqs(){
	String seq = genRandomString(1000);
	// Map<Character,Double> charFreqs = new HashMap<Character,Double>();
	HashTable<Character,Double> charFreqs = new HashTableImp<Character,Double>(50,HashMethod.MAD);
	...
	for(int i = 0; i < 10; ++i){
	    ...
	    HashTable<Character,Double> charFreqs = getRandomFreqs();
	    normalize(charFreqs);
	    // Map<Character,String> codes = runHuffCode(charFreqs);
	    HashTable<Character,String> codes = runHuffCode(charFreqs);
	...
	for (Test t : tests){
	    ...
	    HashTable<Character,String> retCodes = runHuffCode(t.getCharFreq());
	...
	case 0:
	    ...
	    HashTable<Character, Double> charFreqs = new HashTableImp<Character, Double>(6,HashMethod.MAD);
	    ...
	    HashTable<Character,String> code = runHuffCode(charFreqs);
