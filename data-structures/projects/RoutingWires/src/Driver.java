...
public class Driver {
    ...
    public static Board buildBoard(ArrayList<Coord[]> points, ArrayList<Integer[]> obstacles, String filename) {
        try {
...
//        System.out.println("Solved Board:"); board.pretty_print_grid();
