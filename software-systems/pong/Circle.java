...
//  }
  ...
  protected void move(int dx, int dy, double speed) { // Extra speed modifier parameter
    super.moveLoc(dx * speed, dy * speed);
    center = new Point((this.center).x() + (dx * speed), (this.center).y() + (dy * speed));
  }
